    ...
    <section id="home" class="h-screen">
        <div
            ...
            <div class="mx-auto w-screen text-center mt-64">
                <div class="grid justify-center place-items-center items-center text-center">
                    <div class="h-full w-24 md:w-74 text-neutral-50">
                        <img src="https://media3.giphy.com/media/Q86eHqJG75ReBFu9TB/200w.gif?cid=6c09b952acamrcbwyyujwdi6178pcu8di2018ykyzezcp2zg&ep=v1_stickers_search&rid=200w.gif&ct=s" alt="">
                    </div>
                    <div class="w-full">
                    ...
                    <div class="h-full w-24 md:w-68 text-neutral-50 py-4">
