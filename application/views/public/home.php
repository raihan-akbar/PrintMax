        ...
        <div class="max-w-3xl mx-auto px-5 my-20">
            <div class="flex flex-col justify-center">
                ...
                <div class="text-center">
                    ...
                    <h2 class="font-semibold text-3xl text-blue-950 mb-4">Trusted By Great Companies</h2>
                </div>
                ...
                <div class="flex flex-wrap items-center justify-center gap-4 mt-2 md:justify-around">
                    ...
                    <div class="text-neutral-400">
                        <img src="https://cdn.worldvectorlogo.com/logos/gojek-logo-2019.svg" alt="Gojek Logo" class="max-w-[120px] max-h-[60px]">
                    </div>
                    <div class="text-neutral-400">
                        <img src="https://cdn.worldvectorlogo.com/logos/mclaren-racing-logo.svg" alt="Gojek Logo" class="max-w-[120px] max-h-[60px]">
                    </div>
                    <div class="text-neutral-400">
                        <img src="https://cdn.worldvectorlogo.com/logos/spotify-logo.svg" alt="Gojek Logo" class="max-w-[120px] max-h-[60px]">
                    </div>
                    <div class="text-neutral-400">
                        <img src="https://cdn.worldvectorlogo.com/logos/netflix-4.svg" alt="Gojek Logo" class="max-w-[120px] max-h-[60px]">
                    </div>
                    <div class="text-neutral-400">
                        <img src="https://cdn.worldvectorlogo.com/logos/chelsea-fc-2.svg" alt="Gojek Logo" class="max-w-[120px] max-h-[60px]">
                    </div>
