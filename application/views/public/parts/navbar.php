				...
				<div class="grid grid-cols-2 gap-4">
					<div>
						...
						<input type="text" name="customer_name" required
							class="w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white p-2.5 text-sm">
					</div>
					<div>
						<label class="block text-sm font-medium dark:text-white mb-1">Customer Phone</label>
